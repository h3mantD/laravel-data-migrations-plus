...
it('computes sha256 hash of file contents', function () {
...
it('returns different checksums for different content', function () {
...
it('detects drift when content changes', function () {
    $file = $this->tempDir.'/test_migration.php';
...
it('reports no drift when content is unchanged', function () {
    $file = $this->tempDir.'/test_migration.php';
